...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\E-learn\Let's Code\python\programs python\pythonProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\E-learn\Let's Code\python\programs python\pythonProject\venv\Scripts\deactivate.nu'
